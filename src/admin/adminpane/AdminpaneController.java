...
public class AdminpaneController implements Initializable {
    ...
    public void setCbRoles() {
        cbRoles.setItems(FXCollections.observableArrayList(jptv22fxlibrary.JPTV22FXLibrary.roles.values()));
        //Настройка механизма отображения в ComboBox
        cbRoles.setCellFactory(param -> new ListCell<jptv22fxlibrary.JPTV22FXLibrary.roles>(){
            @Override
            protected void updateItem(jptv22fxlibrary.JPTV22FXLibrary.roles item,boolean empty){
        ...
        cbRoles.setButtonCell(new ListCell<jptv22fxlibrary.JPTV22FXLibrary.roles>() {
            @Override
            protected void updateItem(jptv22fxlibrary.JPTV22FXLibrary.roles item, boolean empty) {
                super.updateItem(item, empty);
        ...
        cbRoles.setOnAction(event->{
            this.selectedRole = (jptv22fxlibrary.JPTV22FXLibrary.roles) cbRoles.getValue();
