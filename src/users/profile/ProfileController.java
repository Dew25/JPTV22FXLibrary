...
public class ProfileController implements Initializable {
    ...
    @FXML private void clickUpdateProfile(){
        ...
        try {
            ...
            jptv22fxlibrary.JPTV22FXLibrary.currentUser = updateUser;
    ...
    public void initProfileForm(){
        updateUser = homeController.getEntityManager().find(User.class, jptv22fxlibrary.JPTV22FXLibrary.currentUser.getId());
